...
$\frac{\Delta x_j}{x_j}$ es chica, entonces aproximadamente
$$ \frac{\Delta y}{y} \approx b_j \frac{\Delta x_j}{x_j}$$
...
a veces puede ser difícil descubrir exactamente qué transformaciones pueden ser
