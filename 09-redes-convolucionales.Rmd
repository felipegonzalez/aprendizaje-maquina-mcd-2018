...
if(!usar_cache){
    ...
    model_2 %>% compile(
      ...
      optimizer = optimizer_sgd(lr = 0.035,  momentum = 0.5),
...
```{r}
ggplot(capa_out %>% filter(unidad %in% c(1,2)), 
...
- La unidad 8 está encendida (hay línea horizontal)
- 3 y 4 están apagadas (no hay verticales).
- 1 y 2 están encendidas en un patrón diagonal (extiende la línea diagonal)
- 5, 6  detectan comienzos de líneas horizontales.
- 7 detecta el comienzo de una diagonal.
