...
$$\hat{f}_\beta(X) = \hat{\beta}_0 + \hat{\beta}_1 X_1 + \hat{\beta}_2 X_2 \cdots + \hat{\beta} X_p$$
y usaremos esta función $\hat{f}_\beta$ para hacer predicciones $\hat{Y} =\hat{f}_\beta(X)$.
