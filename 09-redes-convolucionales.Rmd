...
grid.arrange(graf_activaciones(activaciones_1, 6), 
             graf_activaciones(activaciones_2, 6), ncol=2)
grid.arrange(graf_activaciones(activaciones_1, 15), 
             graf_activaciones(activaciones_2, 15), ncol=2)
grid.arrange(graf_activaciones(activaciones_1, 50), 
             graf_activaciones(activaciones_2, 50), ncol=2)
```
