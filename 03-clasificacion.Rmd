...
Como este problema es de dos clases, podemos graficar como sigue (nótese que la
variación alreddor de 1 y 0 es artificial, solo graficamos así para ver 
los puntos individuales):

```{r}
graf_1 <- ggplot(dat_ent, aes(x = x)) +
  geom_jitter(aes(colour = g, y = as.numeric(g=='1')), width=0.5, height=0.05)
graf_1
```
